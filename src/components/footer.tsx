    ...
    <footer className="bg-neutral-900 pt-4 md:pt-16 px-5 md:px-[6.25rem] pb-2.5 text-neutral-50 pr-10">
      <div className="flex md:flex-row flex-col">
        <div className="pt-4 md:pt-10 border-y border-r border-neutral-300 md:basis-3/5 flex flex-col md:gap-6 md:pb-6 pb-3 md:pr-10 pr-3">
          <h2 className="font-gilroy font-extrabold text-2xl md:text-[4rem] leading-9 md:leading-[5rem]">
            {footerContent.title}
          </h2>
          <Link
            href="/sneakers"
            className="px-3 py-2 md:px-4 md:py-2.5 text-sm md:text-base flex gap-2 items-center w-fit text-brand-500 font-semibold hover:bg-brand-500/10 rounded-full"
          >
